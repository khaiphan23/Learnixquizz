          ...
          {filtered.map(q => (
            ...
            <div key={q.id} className="flex flex-col gap-2">
              ...
              >
                ...
                {t.lang === 'vi' ? 'Vào làm bài' : 'Start Quiz'}
              </button>
            </div>
          ))}
        </div>
    ...
    <div className="max-w-2xl mx-auto px-4 py-8 space-y-8">
      ...
      <Modal isOpen={deleteModal} onClose={() => setDeleteModal(false)} title={t.deleteAccount}>
        <p className="text-slate-600 dark:text-slate-400 text-sm">
          {t.lang === 'vi' ? 'Tài khoản của bạn sẽ bị xóa vĩnh viễn. Hành động này không thể hoàn tác.' : 'Your account will be permanently deleted. This action cannot be undone.'}
        </p>
